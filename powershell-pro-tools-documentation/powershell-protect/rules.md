...
#### AMSI Bypass Protection <a id="amsi-bypass-protection"></a>
...
#### Module and Script Block Logging Bypass Protection <a id="module-and-script-block-logging-bypass-protection"></a>
...
#### Assembly Load from Memory <a id="assembly-load-from-memory"></a>
...
#### Disabling Defender <a id="disabling-defender"></a>
...
#### Invoke-Expression <a id="use-of-the-systemreflectionemit-namespace"></a>
...
#### Use of the System.Reflection.Emit Namespace <a id="use-of-the-systemreflectionemit-namespace"></a>
...
#### Marshal Class <a id="marshal-class"></a>
...
#### Persistent WMI Event Subscription <a id="persistent-wmi-event-subscription"></a>
...
#### BloudHound Injestor Execution <a id="bloudhound-injestor-execution"></a>
...
#### Kerberoasting <a id="kerberoasting"></a>
...
PowerShell Protect looks for signs of this type of attack being performed based on signatures found in scripts like [Invoke-Kerberoasting.ps1](https://github.com/EmpireProject/Empire/blob/master/data/module_source/credentials/Invoke-Kerberoast.ps1).
